        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-16">
            ...
            >
              ...
              <div className="bg-slate-50 p-6 sm:p-10 rounded-3xl border border-slate-100 shadow-sm">
                <div className="prose prose-slate prose-sm sm:prose-lg max-w-none">
                  ...
                  <div className="p-4 sm:p-6 bg-white rounded-2xl border-l-4 border-green-600 shadow-sm">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                {university.programs.map((category, idx) => (
                  <div key={idx} className="group bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 hover:border-green-200 hover:shadow-xl transition-all duration-300 flex flex-col">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-16">
                  <div className="space-y-6">
                    <h3 className="text-xl font-bold text-green-400 uppercase tracking-wider">Unique Advantages</h3>
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-32 space-y-8">
              ...
              <div className="bg-white p-8 sm:p-10 rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100">
                ...
                <div className="space-y-4 mb-10">
                  <div className="flex justify-between items-center p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <span className="text-green-700 font-bold px-3 py-1 bg-green-50 rounded-lg">{university.durations.undergraduate}</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    <span className="font-semibold text-slate-600">Masters</span>
                    <span className="text-green-700 font-bold px-3 py-1 bg-green-50 rounded-lg">{university.durations.masters}</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    <span className="font-semibold text-slate-600">PhD</span>
                    <span className="text-green-700 font-bold px-3 py-1 bg-green-50 rounded-lg">{university.durations.phd}</span>
                  </div>
                </div>

                <Button 
                  onClick={handleApply}
                  className="w-full bg-green-600 hover:bg-green-700 text-white h-16 text-xl font-bold rounded-2xl shadow-xl shadow-green-100 transition-all hover:scale-[1.02] active:scale-[0.98]"
                >
                  Apply Now
                </Button>
              ...
              {/* Foundation Support */}
              <div className="bg-green-600 text-white p-8 sm:p-10 rounded-[2.5rem] shadow-xl relative overflow-hidden group">
