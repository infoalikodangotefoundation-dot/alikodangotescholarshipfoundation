        ...
        <div className="pointer-events-auto space-y-6 animate-in fade-in slide-in-from-left duration-1000">
          ...
          <div className="space-y-2">
            ...
            <p className="text-white/70 text-sm lg:text-base leading-relaxed">
              ...
              Create an account today and take the first step towards a brighter future.
            </p>
          </div>
          <div className="flex gap-4 pt-4">
            ...
            <p className="text-xs lg:text-sm self-center text-white/70">Over 10,000 scholarships awarded</p>
          </div>
        </div>
      </div>
