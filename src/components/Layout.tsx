...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans">
            ...
            <div className="flex items-center space-x-4">
              ...
              {currentUser ? (
                <>
                  ...
                  <Link to="/notifications" onClick={() => handleNavClick('/notifications')} className={`font-medium px-3 py-2 rounded-md transition-colors ${location.pathname === '/notifications' ? 'text-green-700 bg-green-50' : 'text-gray-700 hover:text-green-700'}`}>
                    <Bell className="w-5 h-5" />
                  </Link>
                  <Link to="/profile" onClick={() => handleNavClick('/profile')} className={`font-medium px-3 py-2 rounded-md transition-colors ${location.pathname === '/profile' ? 'text-green-700 bg-green-50' : 'text-gray-700 hover:text-green-700'}`}>
      ...
      <footer className="relative z-10 bg-slate-900 text-slate-300 py-8 mt-auto pb-24 md:pb-8">
